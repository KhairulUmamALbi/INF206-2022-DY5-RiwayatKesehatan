                        ...
                        <form class="md-float-material" action="" method="post">
                            ...
                            <div class="auth-box">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h5 style="color: black; padding-top: 18px;" class="text-left txt-primary">
                                            <b>Silahkan lakukan Reset Password</b></h5>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<body>
    ...
    <table cellpadding="3" cellspacing="3">
        ...
        <div class="alert alert-primary d-flex align-items-center" role="alert">
            <svg xmlns=<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
